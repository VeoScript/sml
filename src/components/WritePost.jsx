...
export default function WritePost({ account }) {
  // for modal functions
  ...
  return (
    <>
      <button type="button" onClick={openModal} className="w-full text-base text-white bg-marigold rounded-full space-x-3 px-5 py-2 mb-5 transition ease-in-out duration-300 hover:bg-opacity-80 focus:outline-none">
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog
          ...
          onClose={closeModal}
        >
          <div className="flex flex-row items-start justify-center w-full min-h-screen bg-panther bg-opacity-70 px-4 text-center">
            <Transition.Child
              as={Fragment}
            ...
            >
              <div className="inline-block w-full max-w-xl my-8 overflow-hidden text-left align-middle transition-all transform bg-ghostwhite shadow-xl rounded-2xl">
