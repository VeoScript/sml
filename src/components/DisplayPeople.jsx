export default function DisplayPeople({ people }) {
  return (
    <div className="flex flex-col w-full h-full max-h-[15rem] overflow-y-auto px-3 pb-3 border-b border-marigold border-opacity-30 space-y-2">
      ...
      {people.map(({ image, name, username }, i) => (
        <div className="flex flex-row items-center justify-between w-full" key={i}>
          ...
          <button>
            <svg className="w-5 h-5 fill-current text-marigold" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
