          ...
          <div className="flex flex-col items-center w-full space-y-3">
            <form onSubmit={handleSubmit(handleSignUp)} className="flex flex-col w-full max-w-sm space-y-2">
              ...
              <div className="flex flex-col w-full space-y-1">
                <input className="w-full px-5 py-3 rounded-lg bg-sml-dim text-sml-white focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" type="text" name="image" placeholder="Image Url" {...register("image", { required: true })} disabled={isSubmitting} />
                {errors.image && <span className="text-xs text-sml-mocha ml-1">Image URL is required.</span>}
              </div>
              <div className="flex flex-col w-full space-y-1">
                <input className="w-full px-5 py-3 rounded-lg bg-sml-dim text-sml-white focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" type="text" name="name" placeholder="Name" {...register("name", { required: true })} disabled={isSubmitting}  />
                {errors.name && <span className="text-xs text-sml-mocha ml-1">Name is required.</span>}
              </div>
              <div className="flex flex-col w-full space-y-1">
                <input className="w-full px-5 py-3 rounded-lg bg-sml-dim text-sml-white focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" type="email" name="email" placeholder="Email" {...register("email", { required: true })} disabled={isSubmitting}  />
                {errors.email && <span className="text-xs text-sml-mocha ml-1">Email is required.</span>}
              </div>
              <div className="flex flex-col w-full space-y-1">
              ...
              <div className="flex flex-row w-full space-x-2">
                ...
                <div className="flex flex-col w-full space-y-1">
                  <input className="w-full px-5 py-3 rounded-lg bg-sml-dim text-sml-white focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" type="password" name="repassword" placeholder="Re-Enter Password" {...register("repassword", { required: true })} disabled={isSubmitting}  />
                  {errors.repassword && <span className="text-xs text-sml-mocha ml-1">Re-Enter Password is required.</span>}
                </div>
              </div>
              <button className="w-full px-5 py-3 rounded-lg bg-sml-dim text-sml-mocha transition ease-in-out duration-200 focus:outline-none hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50" type="submit" disabled={isSubmitting}>Sign Up</button>
            </form>
